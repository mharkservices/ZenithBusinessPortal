...
const getComplianceEventCategory = (date) => {
  for (const category in complianceEvents) {
    const events = complianceEvents[category];
...
const getEventsForDate = (date) => {
  const events = [];
  for (const category in complianceEvents) {
    const categoryEvents = complianceEvents[category];
...
const getEventsForMonth = (month, year, selectedCategory) => {
  const events = [];
                ...
                <Calendar
                  ...
                  onDayClick={(day) => {
                    if (hasComplianceEvent(day)) {
                      ...
                      const tabElement = document.querySelector('[data-value="selected"]');
